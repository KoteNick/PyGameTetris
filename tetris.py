...
path = f"{tempfile.gettempdir()}/tetrisScores.txt"
...
class field:
    ...
    def erase_lines(self):
        ...
        for i in range(4):
            ...
            pygame.time.wait(int(1000/vnorm/8))
            self.draw()
            pygame.display.update()
            pygame.time.wait(int(1000/vnorm/8))
...
pygame.key.set_repeat(int(1000/vnorm/2),int(1000/vnorm/8))
...
hs_font=pygame.font.Font("font.ttf",24)
        ...
        if not pause:
            ...
            if p.settled :
                ...
                if erased:
                    ...
                    v=vnorm=level+1
                    if l!=level : pygame.key.set_repeat(int(1000/vnorm/2),int(1000/vnorm/8))
